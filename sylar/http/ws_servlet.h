...
namespace http {
    ...
    public:
        ...
        virtual int32_t handle(sylar::http::HttpRequest::ptr header, sylar::http::WSFrameMessage::ptr msg,
    ...
    public:
        ...
        typedef std::function<int32_t(sylar::http::HttpRequest::ptr header, sylar::http::WSSession::ptr session)>
            on_connect_cb;
        typedef std::function<int32_t(sylar::http::HttpRequest::ptr header, sylar::http::WSSession::ptr session)>
            on_close_cb;
        typedef std::function<int32_t(sylar::http::HttpRequest::ptr header, sylar::http::WSFrameMessage::ptr msg,
