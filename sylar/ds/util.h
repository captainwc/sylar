...
namespace ds {
    ...
    class Murmur3Hash {
    public:
        uint32_t operator()(const T& data) { return sylar::murmur3_hash(&data, sizeof(T), seed); }
    };
    ...
    struct MultiPair {
        ...
        bool operator==(const Pair<K, V>& o) const { return memcmp(this, &o, sizeof(MultiPair<K, V>)) == 0; }
    ...
    public:
        uint32_t operator()(const std::string& data) { return sylar::murmur3_hash(data.data(), data.size(), seed); }
    };
    ...
    class Murmur3Hash64 {
    public:
        uint64_t operator()(const T& data) { return sylar::murmur3_hash64(&data, sizeof(T), seed, seed2); }
    };
